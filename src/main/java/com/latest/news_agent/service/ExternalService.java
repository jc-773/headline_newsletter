...
public class ExternalService {
    ...
    private static final String POLITICS_PROMPT = "Provide a concise summary of today’s top political world headlines. Always format the response using the following structure, regardless of the news content. Begin each topic with a bolded category title using this format: **Category Name**\\n. Follow with a single bullet point - summarizing the news story in 1–3 sentences. End each summary with a markdown link to the source [Source](URL). Separate each topic with two line breaks. Include as much detail as possible while staying within a 1000-token limit.";
    private static final String HEALTH_PROMPT = "Provide a concise summary of today’s top health world headlines. Always format the response using the following structure, regardless of the news content. Begin each topic with a bolded category title using this format: **Category Name**\\n. Follow with a single bullet point - summarizing the news story in 1–3 sentences. End each summary with a markdown link to the source [Source](URL). Separate each topic with two line breaks. Include as much detail as possible while staying within a 1000-token limit.";
    private static final String TECHNOLOGY_PROMPT = "Provide a concise summary of today’s top technology headlines in the world. Always format the response using the following structure. Begin each topic with a bolded category title using this format: **Category Name**\\n. Follow with a single bullet point - summarizing the news story in 1–3 sentences. End each summary with a markdown link to the source [Source](URL). Separate each topic with two line breaks. Include as much detail as possible while staying within a 1000-token limit.";
